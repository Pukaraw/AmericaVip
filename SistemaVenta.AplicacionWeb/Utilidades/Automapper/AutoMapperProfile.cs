    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<DetalleVenta, VMReporteVenta>()
                ...
                opt => opt.MapFrom(origen => Convert.ToDecimal(origen.IdVentaNavigation.SubTotal.Value, new CultureInfo("es-PE")))
                )
                .ForMember(destino =>
                destino.ImpuestoTotalVenta,
                opt => opt.MapFrom(origen => Convert.ToDecimal(origen.IdVentaNavigation.ImpuestoTotal.Value, new CultureInfo("es-PE")))
                )
                .ForMember(destino =>
                destino.TotalVenta,
                opt => opt.MapFrom(origen => Convert.ToDecimal(origen.IdVentaNavigation.Total.Value, new CultureInfo("es-PE")))
                )
                .ForMember(destino =>
                destino.Producto,
                ...
                .ForMember(destino =>
                destino.Precio,
                opt => opt.MapFrom(origen => Convert.ToDecimal(origen.Precio.Value, new CultureInfo("es-PE")))
                )
                .ForMember(destino =>
                destino.Total,
